...
def argument_parser():
    ...
    parser.add_argument('-d', '--dataset', type=str, default='mnist', required=True, help='mnist, fashion_mnist or others')
    ...
    parser.add_argument('--slpoe', type=float, default=0.2, help='leakyrelu\'s negative slope')
