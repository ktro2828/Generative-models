...
def main():
    ...
    G = Generator(args.dataset, args.latent_dim, args.leakyrelu, args.slope)
    D = Discriminator(args.dataset, args.slope, args.droprate)

    G_optimizer = torch.optim.Adam(G.optimizers(), lr=args.lr)
    D_optimizer = torch.optim.Adam(D.optimizers(), lr=args.lr)
